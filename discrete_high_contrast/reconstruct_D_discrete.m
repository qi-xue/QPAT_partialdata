...
ax = gca;
set(ax,'FontSize',15)
print(fig,'-depsc','diffusion_discrete_reconstruct')
...
ax = gca;
set(ax,'FontSize',15)
print(fig,'-depsc','diffusion_discrete_true')
...
ax = gca;
set(ax,'FontSize',15)
print(fig,'-depsc','diffusion_discrete')
...
ax = gca;
set(ax,'FontSize',15)
print(fig,'-depsc','absorption_discrete_reconstruct')
...
ax = gca;
set(ax,'FontSize',15)
print(fig,'-depsc','absorption_discrete_true')
...
ax = gca;
set(ax,'FontSize',15)
print(fig,'-depsc','absorption_discrete')

close all

%% Compare with background truth
disp("Relative error for diffusion coefficient:")
disp(norm(D(indNor)-DTru(indNor))/norm(DTru(indNor))) % 8.56%
disp("Relative error for absorption coefficient:")
disp(norm(mu(indNor)-muTru(indNor))/norm(muTru(indNor))) % 4.70%
